...
from tools.monitoring.models import PipelineStage, MetricType, ErrorCategory
import pandas as pd
...
def main(input_file: str = "01_llmpipeline/specbook.csv", 
         output_dir: str = "01_llmpipeline",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", default="01_llmpipeline",
