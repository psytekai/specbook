...
Examples:
  ...
  # Custom input file
  python run_benchmarks.py --input workspace/input/test_urls.csv --models gpt-4o-mini
        """
    )
    ...
    # Output options
    parser.add_argument("--output-dir", default="workspace/output/benchmarks",
    ...
    try:
        ...
        if args.force_cache_import:
            logger.info("Force importing cache from reference data...")
